      ...
      <div class="col-md-3 col-sm-6">
        <div class="footer-menu footer-menu-002">
          ...
          <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
            ...
            <li class="menu-item">
              <a href="#" class="item-anchor">Single item</a>
            </li>
            <li class="menu-item">
        ...
        <div class="footer-menu footer-menu-004 border-animation-left">
          ...
          <p>Do you have any questions or suggestions?
            <a href="mailto:contact@yourcompany.com"
               class="item-anchor">contact@yourcompany.com</a>
          </p>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 text-end">
          <p>© Copyright <?= date('Y') .' ' . SITE_NAME?>. All rights reserved.
            Design by
            <a href="https://wayoxmedia.com"
               target="_blank">Wayox Media
            </a>
          </p>
        </div>
      </div>
